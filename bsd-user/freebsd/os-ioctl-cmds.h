...
#else
IOCTL2(TIOCGETA, TCGETS, IOC_R, MK_PTR(MK_STRUCT(STRUCT_termios)))
IOCTL2(TIOCSETA, TCSETS, IOC_W, MK_PTR(MK_STRUCT(STRUCT_termios)))
IOCTL2(TIOCSETAW, TCSETSW, IOC_W, MK_PTR(MK_STRUCT(STRUCT_termios)))
IOCTL2(TIOCSETAF, TCSETSF, IOC_W, MK_PTR(MK_STRUCT(STRUCT_termios)))
#endif
#if !defined(__linux__)
